...
from exp.stock_forecasting import Stock_Forecast, Stock_Forecast_DRIP   
...
# DRIP
parser.add_argument('--enable_DRIP', type=int, default=0, help='')
parser.add_argument('--num_stock', type=int, default=None, help='')

# retrain
parser.add_argument('--use_ckpt', type=int, default=0, help='')
parser.add_argument('--ckpt_path', type=str, default=None, help='TimeMixer/....')
...
if __name__ == '__main__':
    ...
    elif args.task_name == 'stock_forecast_DRIP':
        Exp = Stock_Forecast_DRIP    
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_{}_{}_dsl{}_lr{}_sl{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_fc{}_eb{}_dt{}_{}_{}'.format(
                args.task_name,
                args.model_id,
                args.comment,
                args.model,
